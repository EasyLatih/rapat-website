...
if(form && statusBox && submitButton){
  ...
  form.addEventListener('submit',async(e)=>{
    ...
    try{
      ...
      statusBox.textContent='Thank you. Your collaboration enquiry has been submitted. We will contact you to discuss the next step.';statusBox.className='status ok';form.reset();
